<?php
require(QCUBED_PROJECT_PANEL_GEN_DIR . '/HutEditPanelGen.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Hut class. This is where you should create your customizations to the edit
 * panel that edits a hut record.
 *
 * This file is intended to be modified. Subsequent code regenerations will NOT modify
 * or overwrite this file.
 */
class HutEditPanel extends HutEditPanelGen
{
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = QCUBED_PROJECT_PANEL_GEN_DIR . '/HutEditPanel.tpl.php';
	}
}
