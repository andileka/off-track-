...
if (!defined('__PREPEND_INCLUDED__')) {
	...
	if(!defined('__DOCROOT__')) {
		echo "__DOCROOT__ is undefined, please define it.";
		exit;
	}
    ...
    \QCubed\AutoloaderService::instance()
		...
		->addPsr4('Hikify\\', __DOCROOT__ . '/project/assets/php')
		->addPsr4('Hikify\\Errors\\', __DOCROOT__ . '/project/assets/php/errors')
		->addPsr4('Hikify\\Pages\\', __DOCROOT__ . '/project/assets/php/pages')
		->addPsr4('Hikify\\Panels\\', __DOCROOT__ . '/project/assets/php/panels')
		->addPsr4('Hikify\\Helpers\\', __DOCROOT__ . '/project/assets/php/helpers')
    ;
...
*/
	...
	function tr($text) {
		return \QCubed\Project\Application::t($text);
	}

	function _log($strWhat) {
		\QCubed\Project\Application::Log($strWhat);
	}
    ////////////////
    // Include Files
    ////////////////
