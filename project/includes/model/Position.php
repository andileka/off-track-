<?php
	...
	class Position extends PositionGen {
		...
		public function __toString() {
			return 'Position Object ' . $this->PrimaryKey();
		}
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of Position objects
			return Position::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Position()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Position()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Position object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Position objects
			return Position::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Position()->Param1, $strParam1),
					QQ::Equal(QQN::Position()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return Position::InstantiateDbResult($objDbResult);
		}
*/
