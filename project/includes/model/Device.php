<?php
	...
	class Device extends DeviceGen {
		...
		public function __toString() {
			return 'Device Object ' . $this->PrimaryKey();
		}
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of Device objects
			return Device::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Device()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Device()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Device objects
			return Device::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Device()->Param1, $strParam1),
					QQ::Equal(QQN::Device()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return Device::InstantiateDbResult($objDbResult);
		}
*/
