...
class CompanyEditDlg extends CompanyEditDlgGen
{
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the CompanyEditPanel panel that is
