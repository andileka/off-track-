...
class CityEditDlg extends CityEditDlgGen
{
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the CityEditPanel panel that is
