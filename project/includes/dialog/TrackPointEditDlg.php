...
class TrackPointEditDlg extends TrackPointEditDlgGen
{
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the TrackPointEditPanel panel that is
