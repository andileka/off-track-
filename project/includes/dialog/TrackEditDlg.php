...
class TrackEditDlg extends TrackEditDlgGen
{
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the TrackEditPanel panel that is
