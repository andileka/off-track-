...
class EventEditDlg extends EventEditDlgGen
{
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the EventEditPanel panel that is
