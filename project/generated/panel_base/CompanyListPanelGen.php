...
abstract class CompanyListPanelGen extends \QCubed\Control\Panel
{
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgCompanies_Create();
		$this->createFilterPanel();
		$this->dtgCompanies->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgCompanies_Create() 
	{
		$this->dtgCompanies = new CompanyList($this);
		$this->dtgCompanies_CreateColumns();
		$this->dtgCompanies_MakeEditable();
		$this->dtgCompanies->RowParamsCallback = [$this, "dtgCompanies_GetRowParams"];
        $this->dtgCompanies->LinkedNode = QQN::Company();
	}
	...
	**/
	...
	{
		$this->dtgCompanies->createColumns();
	}
    /**
	...
	{
		$this->dtgCompanies->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgCompanies_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgCompanies->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgCompanies_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgCompanies_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	public function bindData() {
		...
		$this->dtgCompanies->bindData($objCondition);
	}
	...
	protected function getCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return \QCubed\Query\QQ::orCondition(
				\QCubed\Query\QQ::equal(QQN::Company()->Id, $strSearchValue),
            \QCubed\Query\QQ::like(QQN::Company()->Name, "%" . $strSearchValue . "%")
			);
		}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/company_edit.php' . $strQuery;
