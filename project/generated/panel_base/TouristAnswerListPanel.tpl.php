<?php
	/**
	 * This is a draft template file for the TouristAnswerListPanel.
     ...
     * Template property of the TouristAnswerListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgTouristAnswers); ?>
<?= _r($this->pnlButtons); ?>
