...
/**
 * This is the base list class for the  Question class.
 *
 * Do not edit this file, this file is overwritten on any code regenerations. Make any changes you need to the subclass.
 *
 */
abstract class QuestionListPanelGen extends \QCubed\Control\Panel
{
	/** @var Panel **/
	protected $pnlFilter;
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgQuestions_Create();
		$this->createFilterPanel();
		$this->dtgQuestions->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgQuestions_Create() 
	{
		$this->dtgQuestions = new QuestionList($this);
		$this->dtgQuestions_CreateColumns();
		$this->dtgQuestions_MakeEditable();
		$this->dtgQuestions->RowParamsCallback = [$this, "dtgQuestions_GetRowParams"];
        $this->dtgQuestions->LinkedNode = QQN::Question();
	}
	...
	**/
	...
	{
		$this->dtgQuestions->createColumns();
	}
    /**
	...
	{
		$this->dtgQuestions->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgQuestions_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgQuestions->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgQuestions_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgQuestions_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	public function bindData() {
		...
		$this->dtgQuestions->bindData($objCondition);
	}
	...
	protected function getCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return \QCubed\Query\QQ::orCondition(
				\QCubed\Query\QQ::equal(QQN::Question()->Id, $strSearchValue),
            \QCubed\Query\QQ::like(QQN::Question()->Question, "%" . $strSearchValue . "%")
			);
		}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/question_edit.php' . $strQuery;
