...
/**
 * This is the base list class for the  Language class.
 *
 * Do not edit this file, this file is overwritten on any code regenerations. Make any changes you need to the subclass.
 *
 */
abstract class LanguageListPanelGen extends \QCubed\Control\Panel
{
	/** @var Panel **/
	protected $pnlFilter;
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgLanguages_Create();
		$this->createFilterPanel();
		$this->dtgLanguages->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgLanguages_Create() 
	{
		$this->dtgLanguages = new LanguageList($this);
		$this->dtgLanguages_CreateColumns();
		$this->dtgLanguages_MakeEditable();
		$this->dtgLanguages->RowParamsCallback = [$this, "dtgLanguages_GetRowParams"];
        $this->dtgLanguages->LinkedNode = QQN::Language();
	}
	...
	**/
	...
	{
		$this->dtgLanguages->createColumns();
	}
    /**
	...
	{
		$this->dtgLanguages->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgLanguages_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgLanguages->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgLanguages_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgLanguages_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	public function bindData() {
		...
		$this->dtgLanguages->bindData($objCondition);
	}
	...
	protected function getCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return \QCubed\Query\QQ::orCondition(
				\QCubed\Query\QQ::equal(QQN::Language()->Id, $strSearchValue),
            \QCubed\Query\QQ::like(QQN::Language()->Name, "%" . $strSearchValue . "%"),
            \QCubed\Query\QQ::like(QQN::Language()->Locale, "%" . $strSearchValue . "%")
			);
		}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/language_edit.php' . $strQuery;
