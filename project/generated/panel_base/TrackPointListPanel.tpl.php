<?php
	/**
	 * This is a draft template file for the TrackPointListPanel.
     ...
     * Template property of the TrackPointListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgTrackPoints); ?>
<?= _r($this->pnlButtons); ?>
