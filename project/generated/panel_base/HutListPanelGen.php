...
abstract class HutListPanelGen extends \QCubed\Control\Panel
{
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgHuts->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgHuts_Create() 
	{
		$this->dtgHuts = new HutList($this);
		$this->dtgHuts_CreateColumns();
		$this->dtgHuts_MakeEditable();
		$this->dtgHuts->RowParamsCallback = [$this, "dtgHuts_GetRowParams"];
        $this->dtgHuts->LinkedNode = QQN::Hut();
	}
	...
	**/
	...
	{
		$this->dtgHuts->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgHuts_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgHuts->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgHuts_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgHuts_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	public function bindData() {
		...
		$this->dtgHuts->bindData($objCondition);
	}
	...
	protected function getCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return \QCubed\Query\QQ::orCondition(
				\QCubed\Query\QQ::equal(QQN::Hut()->Id, $strSearchValue),
            \QCubed\Query\QQ::equal(QQN::Hut()->PositionId, $strSearchValue),
            \QCubed\Query\QQ::like(QQN::Hut()->Name, "%" . $strSearchValue . "%")
			);
		}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/hut_edit.php' . $strQuery;
