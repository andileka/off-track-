<?php
	/**
	 * This is a draft template file for the DeviceTouristEditPanel.
     ...
     * Template property of the DeviceTouristEditPanel to point to the new location.
	 **/
?>
