...
abstract class EventListPanelGen extends \QCubed\Control\Panel
{
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgEvents_Create();
		$this->createFilterPanel();
		$this->dtgEvents->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgEvents_Create() 
	{
		$this->dtgEvents = new EventList($this);
		$this->dtgEvents_CreateColumns();
		$this->dtgEvents_MakeEditable();
		$this->dtgEvents->RowParamsCallback = [$this, "dtgEvents_GetRowParams"];
        $this->dtgEvents->LinkedNode = QQN::Event();
	}
	...
	**/
	...
	{
		$this->dtgEvents->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgEvents_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgEvents->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgEvents_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgEvents_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	public function bindData() {
		...
		$this->dtgEvents->bindData($objCondition);
	}
	...
	protected function getCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
            ...
            \QCubed\Query\QQ::like(QQN::Event()->Status, "%" . $strSearchValue . "%")
			);
		}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/event_edit.php' . $strQuery;
