...
abstract class LogListPanelGen extends \QCubed\Control\Panel
{
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgLogs->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgLogs_Create() 
	{
		$this->dtgLogs = new LogList($this);
		$this->dtgLogs_CreateColumns();
		$this->dtgLogs_MakeEditable();
		$this->dtgLogs->RowParamsCallback = [$this, "dtgLogs_GetRowParams"];
        $this->dtgLogs->LinkedNode = QQN::Log();
	}
	...
	**/
	...
	{
		$this->dtgLogs->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgLogs_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgLogs->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgLogs_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgLogs_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	public function bindData() {
		...
		$this->dtgLogs->bindData($objCondition);
	}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/log_edit.php' . $strQuery;
