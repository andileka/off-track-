...
/**
 * This is the base list class for the  DeviceTourist class.
 *
 * Do not edit this file, this file is overwritten on any code regenerations. Make any changes you need to the subclass.
 *
 */
abstract class DeviceTouristListPanelGen extends \QCubed\Control\Panel
{
	/** @var Panel **/
	protected $pnlFilter;
	...
	/** @var DeviceTouristList **/
	protected $dtgDeviceTourists;


	public function __construct($objParent, $strControlId = null) {
		parent::__construct($objParent, $strControlId);
		$this->dtgDeviceTourists_Create();
		$this->createFilterPanel();
		$this->dtgDeviceTourists->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgDeviceTourists_Create() 
	{
		$this->dtgDeviceTourists = new DeviceTouristList($this);
		$this->dtgDeviceTourists_CreateColumns();
		$this->dtgDeviceTourists_MakeEditable();
		$this->dtgDeviceTourists->RowParamsCallback = [$this, "dtgDeviceTourists_GetRowParams"];
        $this->dtgDeviceTourists->LinkedNode = QQN::DeviceTourist();
	}
	...
	**/
	...
	{
		$this->dtgDeviceTourists->createColumns();
	}
    /**
	...
	{
		$this->dtgDeviceTourists->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgDeviceTourists_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgDeviceTourists->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgDeviceTourists_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgDeviceTourists_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	protected function filterChanged() {
		$this->dtgDeviceTourists->refresh();
	}
	...
	public function bindData() {
		...
		$this->dtgDeviceTourists->bindData($objCondition);
	}
	...
	protected function getCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return \QCubed\Query\QQ::orCondition(
				\QCubed\Query\QQ::equal(QQN::DeviceTourist()->Id, $strSearchValue),
            \QCubed\Query\QQ::equal(QQN::DeviceTourist()->DeviceId, $strSearchValue),
            \QCubed\Query\QQ::equal(QQN::DeviceTourist()->TouristId, $strSearchValue)
			);
		}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/device_tourist_edit.php' . $strQuery;
