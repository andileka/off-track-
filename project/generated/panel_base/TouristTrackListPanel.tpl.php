<?php
	/**
	 * This is a draft template file for the TouristTrackListPanel.
     ...
     * Template property of the TouristTrackListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgTouristTracks); ?>
<?= _r($this->pnlButtons); ?>
