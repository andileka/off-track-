...
abstract class DeviceListPanelGen extends \QCubed\Control\Panel
{
	...
	/** @var DeviceList **/
	protected $dtgDevices;


	public function __construct($objParent, $strControlId = null) {
		parent::__construct($objParent, $strControlId);
		$this->dtgDevices_Create();
		$this->createFilterPanel();
		$this->dtgDevices->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgDevices_Create() 
	{
		$this->dtgDevices = new DeviceList($this);
		$this->dtgDevices_CreateColumns();
		$this->dtgDevices_MakeEditable();
		$this->dtgDevices->RowParamsCallback = [$this, "dtgDevices_GetRowParams"];
        $this->dtgDevices->LinkedNode = QQN::Device();
	}
	...
	**/
	...
	{
		$this->dtgDevices->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgDevices_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgDevices->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgDevices_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgDevices_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	public function bindData() {
		...
		$this->dtgDevices->bindData($objCondition);
	}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/device_edit.php' . $strQuery;
