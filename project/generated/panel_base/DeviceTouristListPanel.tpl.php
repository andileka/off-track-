<?php
	/**
	 * This is a draft template file for the DeviceTouristListPanel.
     ...
     * Template property of the DeviceTouristListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgDeviceTourists); ?>
<?= _r($this->pnlButtons); ?>
