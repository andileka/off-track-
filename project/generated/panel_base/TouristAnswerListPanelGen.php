...
/**
 * This is the base list class for the  TouristAnswer class.
 *
 * Do not edit this file, this file is overwritten on any code regenerations. Make any changes you need to the subclass.
 *
 */
abstract class TouristAnswerListPanelGen extends \QCubed\Control\Panel
{
	/** @var Panel **/
	protected $pnlFilter;
	...
	/** @var TouristAnswerList **/
	protected $dtgTouristAnswers;


	public function __construct($objParent, $strControlId = null) {
		parent::__construct($objParent, $strControlId);
		$this->dtgTouristAnswers_Create();
		$this->createFilterPanel();
		$this->dtgTouristAnswers->setDataBinder('BindData', $this);
	...
	**/
	protected function dtgTouristAnswers_Create() 
	{
		$this->dtgTouristAnswers = new TouristAnswerList($this);
		$this->dtgTouristAnswers_CreateColumns();
		$this->dtgTouristAnswers_MakeEditable();
		$this->dtgTouristAnswers->RowParamsCallback = [$this, "dtgTouristAnswers_GetRowParams"];
        $this->dtgTouristAnswers->LinkedNode = QQN::TouristAnswer();
	}
	...
	**/
	...
	{
		$this->dtgTouristAnswers->createColumns();
	}
    /**
	...
	{
		$this->dtgTouristAnswers->addAction(new Q\Event\CellClick(0, null, null, true), new Q\Action\AjaxControl($this, 'dtgTouristAnswers_CellClick', null, null, Q\Event\CellClick::ROW_VALUE));
		$this->dtgTouristAnswers->addCssClass('clickable-rows');
	}
     ...
     */
	protected function dtgTouristAnswers_CellClick($strFormId, $strControlId, $param) 
	{
		if ($param) {
			$this->editItem($param);
		}
     ...
     * @return array
     */
	public function dtgTouristAnswers_GetRowParams($objRowObject, $intRowIndex) 
	{
	...
	protected function filterChanged() {
		$this->dtgTouristAnswers->refresh();
	}
	...
	public function bindData() {
		...
		$this->dtgTouristAnswers->bindData($objCondition);
	}
	...
	protected function getCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return \QCubed\Query\QQ::orCondition(
				\QCubed\Query\QQ::equal(QQN::TouristAnswer()->Id, $strSearchValue),
            \QCubed\Query\QQ::equal(QQN::TouristAnswer()->TouristId, $strSearchValue),
            \QCubed\Query\QQ::equal(QQN::TouristAnswer()->QuestionId, $strSearchValue),
            \QCubed\Query\QQ::like(QQN::TouristAnswer()->Answer, "%" . $strSearchValue . "%")
			);
		}
...
protected function editItem($strKey = null) {
		...
		$strEditPageUrl = QCUBED_FORMS_URL . '/tourist_answer_edit.php' . $strQuery;
