...
include (QCUBED_PROJECT_PANEL_DIR . '/TouristAnswerEditPanel.php');

/**
* This is the TouristAnswerEditDlgGen class.  It uses the code-generated
* TouristAnswerEditPanel class, which has all the controls for editing
* a record in the tourist_answer table.
*
*
* @package My QCubed Application
*/
class TouristAnswerEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('TouristAnswer')),
