...
include (QCUBED_PROJECT_PANEL_DIR . '/TrackEditPanel.php');

/**
* This is the TrackEditDlgGen class.  It uses the code-generated
* TrackEditPanel class, which has all the controls for editing
* a record in the track table.
*
*
* @package My QCubed Application
*/
class TrackEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Track')),
