...
include (QCUBED_PROJECT_PANEL_DIR . '/LogEditPanel.php');

/**
* This is the LogEditDlgGen class.  It uses the code-generated
* LogEditPanel class, which has all the controls for editing
* a record in the log table.
*
*
* @package My QCubed Application
*/
class LogEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Log')),
