...
include (QCUBED_PROJECT_PANEL_DIR . '/DeviceTouristEditPanel.php');

/**
* This is the DeviceTouristEditDlgGen class.  It uses the code-generated
* DeviceTouristEditPanel class, which has all the controls for editing
* a record in the device_tourist table.
*
*
* @package My QCubed Application
*/
class DeviceTouristEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('DeviceTourist')),
