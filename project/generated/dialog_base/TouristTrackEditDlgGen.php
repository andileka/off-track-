...
include (QCUBED_PROJECT_PANEL_DIR . '/TouristTrackEditPanel.php');

/**
* This is the TouristTrackEditDlgGen class.  It uses the code-generated
* TouristTrackEditPanel class, which has all the controls for editing
* a record in the tourist_track table.
*
*
* @package My QCubed Application
*/
class TouristTrackEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('TouristTrack')),
