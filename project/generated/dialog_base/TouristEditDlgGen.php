...
include (QCUBED_PROJECT_PANEL_DIR . '/TouristEditPanel.php');

/**
* This is the TouristEditDlgGen class.  It uses the code-generated
* TouristEditPanel class, which has all the controls for editing
* a record in the tourist table.
*
*
* @package My QCubed Application
*/
class TouristEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Tourist')),
