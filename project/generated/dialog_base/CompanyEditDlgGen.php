...
include (QCUBED_PROJECT_PANEL_DIR . '/CompanyEditPanel.php');

/**
* This is the CompanyEditDlgGen class.  It uses the code-generated
* CompanyEditPanel class, which has all the controls for editing
* a record in the company table.
*
*
* @package My QCubed Application
*/
class CompanyEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Company')),
