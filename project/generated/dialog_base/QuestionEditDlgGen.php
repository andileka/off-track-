...
include (QCUBED_PROJECT_PANEL_DIR . '/QuestionEditPanel.php');

/**
* This is the QuestionEditDlgGen class.  It uses the code-generated
* QuestionEditPanel class, which has all the controls for editing
* a record in the question table.
*
*
* @package My QCubed Application
*/
class QuestionEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Question')),
