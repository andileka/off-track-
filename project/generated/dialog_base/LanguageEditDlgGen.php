...
include (QCUBED_PROJECT_PANEL_DIR . '/LanguageEditPanel.php');

/**
* This is the LanguageEditDlgGen class.  It uses the code-generated
* LanguageEditPanel class, which has all the controls for editing
* a record in the language table.
*
*
* @package My QCubed Application
*/
class LanguageEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Language')),
