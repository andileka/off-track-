...
include (QCUBED_PROJECT_PANEL_DIR . '/CountryEditPanel.php');

/**
* This is the CountryEditDlgGen class.  It uses the code-generated
* CountryEditPanel class, which has all the controls for editing
* a record in the country table.
*
*
* @package My QCubed Application
*/
class CountryEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Country')),
