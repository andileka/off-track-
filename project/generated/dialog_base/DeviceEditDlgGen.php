...
include (QCUBED_PROJECT_PANEL_DIR . '/DeviceEditPanel.php');

/**
* This is the DeviceEditDlgGen class.  It uses the code-generated
* DeviceEditPanel class, which has all the controls for editing
* a record in the device table.
*
*
* @package My QCubed Application
*/
class DeviceEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Device')),
