...
include (QCUBED_PROJECT_PANEL_DIR . '/PositionEditPanel.php');

/**
* This is the PositionEditDlgGen class.  It uses the code-generated
* PositionEditPanel class, which has all the controls for editing
* a record in the position table.
*
*
* @package My QCubed Application
*/
class PositionEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Position')),
