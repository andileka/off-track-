...
include (QCUBED_PROJECT_PANEL_DIR . '/EventEditPanel.php');

/**
* This is the EventEditDlgGen class.  It uses the code-generated
* EventEditPanel class, which has all the controls for editing
* a record in the event table.
*
*
* @package My QCubed Application
*/
class EventEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('Event')),
