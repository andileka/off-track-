...
include (QCUBED_PROJECT_PANEL_DIR . '/TrackPointEditPanel.php');

/**
* This is the TrackPointEditDlgGen class.  It uses the code-generated
* TrackPointEditPanel class, which has all the controls for editing
* a record in the track_point table.
*
*
* @package My QCubed Application
*/
class TrackPointEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('TrackPoint')),
