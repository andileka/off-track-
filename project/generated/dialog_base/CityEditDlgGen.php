...
include (QCUBED_PROJECT_PANEL_DIR . '/CityEditPanel.php');

/**
* This is the CityEditDlgGen class.  It uses the code-generated
* CityEditPanel class, which has all the controls for editing
* a record in the city table.
*
*
* @package My QCubed Application
*/
class CityEditDlgGen extends \QCubed\Project\Control\Dialog
{
	...
	protected function createButtons()
    {
		...
		$this->addButton(t('Delete'), 'delete', false, false,
			sprintf(t('Are you SURE you want to DELETE this %s?'),  t('City')),
