 ...
 * subclasses a Track class and can be used to display
 ...
 *
 */
class TrackListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	{
		$this->colId = $this->createNodeColumn("Id", QQN::Track()->Id);
		$this->colName = $this->createNodeColumn("Name", QQN::Track()->Name);
	}
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Track::queryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Track::queryArray($objCondition, $objClauses);
	}
