 ...
 * subclasses a Device class and can be used to display
 ...
 *
 */
class DeviceListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Device::queryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Device::queryArray($objCondition, $objClauses);
	}
