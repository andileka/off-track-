 ...
 * subclasses a Event class and can be used to display
 ...
 *
 */
class EventListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	{
		$this->colId = $this->createNodeColumn("Id", QQN::Event()->Id);
		$this->colDevice = $this->createNodeColumn("Device", QQN::Event()->Device);
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Event::queryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Event::queryArray($objCondition, $objClauses);
	}
