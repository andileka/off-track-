 ...
 * subclasses a City class and can be used to display
 * a collection of City objects.
 *
 ...
 *
 */
class CityListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	public $colCountryId;
	/** @var NodeColumn */
	public $colPostalCode;
	/** @var NodeColumn */
	public $colName;
	/** @var NodeColumn */
	public $colAdminName1;
	/** @var NodeColumn */
	public $colAdminCode1;
	/** @var NodeColumn */
	public $colAdminName2;
	/** @var NodeColumn */
	public $colAdminCode2;
	/** @var NodeColumn */
	public $colAdminName3;
	/** @var NodeColumn */
	public $colAdminCode3;
	/** @var NodeColumn */
	public $colLatitude;
	/** @var NodeColumn */
	public $colLongitude;
	...
	{
		$this->colId = $this->createNodeColumn("Id", QQN::City()->Id);
		$this->colCountryId = $this->createNodeColumn("Country Id", QQN::City()->CountryId);
		$this->colPostalCode = $this->createNodeColumn("Postal Code", QQN::City()->PostalCode);
		$this->colName = $this->createNodeColumn("Name", QQN::City()->Name);
		$this->colAdminName1 = $this->createNodeColumn("Admin Name 1", QQN::City()->AdminName1);
		$this->colAdminCode1 = $this->createNodeColumn("Admin Code 1", QQN::City()->AdminCode1);
		$this->colAdminName2 = $this->createNodeColumn("Admin Name 2", QQN::City()->AdminName2);
		$this->colAdminCode2 = $this->createNodeColumn("Admin Code 2", QQN::City()->AdminCode2);
		$this->colAdminName3 = $this->createNodeColumn("Admin Name 3", QQN::City()->AdminName3);
		$this->colAdminCode3 = $this->createNodeColumn("Admin Code 3", QQN::City()->AdminCode3);
		$this->colLatitude = $this->createNodeColumn("Latitude", QQN::City()->Latitude);
		$this->colLongitude = $this->createNodeColumn("Longitude", QQN::City()->Longitude);
		$this->colAccuracy = $this->createNodeColumn("Accuracy", QQN::City()->Accuracy);
	}
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = City::queryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = City::queryArray($objCondition, $objClauses);
	}
