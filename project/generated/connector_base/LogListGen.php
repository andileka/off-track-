 ...
 * subclasses a Log class and can be used to display
 ...
 *
 */
class LogListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Log::queryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Log::queryArray($objCondition, $objClauses);
	}
