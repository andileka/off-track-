 ...
 * subclasses a DeviceTourist class and can be used to display
 * a collection of DeviceTourist objects.
 *
 ...
 *
 */
class DeviceTouristListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	{
		$this->colId = $this->createNodeColumn("Id", QQN::DeviceTourist()->Id);
		$this->colDevice = $this->createNodeColumn("Device", QQN::DeviceTourist()->Device);
		$this->colTourist = $this->createNodeColumn("Tourist", QQN::DeviceTourist()->Tourist);
		$this->colStartDate = $this->createNodeColumn("Start Date", QQN::DeviceTourist()->StartDate);
		$this->colEndDate = $this->createNodeColumn("End Date", QQN::DeviceTourist()->EndDate);
	}
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = DeviceTourist::queryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = DeviceTourist::queryArray($objCondition, $objClauses);
	}
