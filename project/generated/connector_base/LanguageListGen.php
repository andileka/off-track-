 ...
 * subclasses a Language class and can be used to display
 ...
 *
 */
class LanguageListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	{
		$this->colId = $this->createNodeColumn("Id", QQN::Language()->Id);
		$this->colName = $this->createNodeColumn("Name", QQN::Language()->Name);
		$this->colLocale = $this->createNodeColumn("Locale", QQN::Language()->Locale);
	}
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Language::queryCount($objCondition, $objClauses);
		}
