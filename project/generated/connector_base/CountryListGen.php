 ...
 * subclasses a Country class and can be used to display
 ...
 *
 */
class CountryListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	{
		$this->colId = $this->createNodeColumn("Id", QQN::Country()->Id);
		$this->colIsoCode = $this->createNodeColumn("Iso Code", QQN::Country()->IsoCode);
		$this->colTelCode = $this->createNodeColumn("Tel Code", QQN::Country()->TelCode);
		$this->colEuropeanUnion = $this->createNodeColumn("European Union", QQN::Country()->EuropeanUnion);
		$this->colNameEn = $this->createNodeColumn("Name En", QQN::Country()->NameEn);
		$this->colNameNl = $this->createNodeColumn("Name Nl", QQN::Country()->NameNl);
		$this->colNameFr = $this->createNodeColumn("Name Fr", QQN::Country()->NameFr);
		$this->colNameEs = $this->createNodeColumn("Name Es", QQN::Country()->NameEs);
		$this->colNameIt = $this->createNodeColumn("Name It", QQN::Country()->NameIt);
		$this->colNameDe = $this->createNodeColumn("Name De", QQN::Country()->NameDe);
		$this->colNamePl = $this->createNodeColumn("Name Pl", QQN::Country()->NamePl);
	}
