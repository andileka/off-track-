 ...
 * subclasses a Company class and can be used to display
 ...
 *
 */
class CompanyListGen extends \QCubed\Project\Control\DataGrid
{
	/**
	...
	{
		$this->colId = $this->createNodeColumn("Id", QQN::Company()->Id);
		$this->colName = $this->createNodeColumn("Name", QQN::Company()->Name);
	}
	...
	*/
	public function bindData(QQCondition $objAdditionalCondition = null, $objAdditionalClauses = null) 
	{
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Company::queryCount($objCondition, $objClauses);
		}
