<?php
/**
 * Generated DeviceTourist base class file
 */
...
/**
 * Class DeviceTouristGen
 *
 * The abstract DeviceTouristGen class defined here is
 * code-generated and contains all the basic CRUD-type functionality as well as
 * basic methods to handle relationships and index-based loading.
 *
 * To use, you should use the DeviceTourist subclass which
 * extends this DeviceTouristGen class.
 *
 * Because subsequent re-code generations will overwrite any changes to this
 * file, you should leave this file unaltered to prevent yourself from losing
 * any information or code changes.  All customizations should be done by
 * overriding existing or implementing new methods, properties and variables
 * in the DeviceTourist class.
 *
...
abstract class DeviceTouristGen extends \QCubed\ObjectBase implements IteratorAggregate, JsonSerializable {
    ...
    /** @var DeviceTourist[] Short term cached DeviceTourist objects */
    ...
    /**
     * Protected member variable that maps to the database PK Identity column device_tourist.id
     * @var integer intId
     */
    private $intId;
    ...
    /**
     * Protected member variable that maps to the database column device_tourist.device_id
    ...
    /**
     * Protected member variable that maps to the database column device_tourist.tourist_id
    ...
    /**
     * Protected member variable that maps to the database column device_tourist.start_date
     * @var \QCubed\QDateTime dttStartDate
     */
    private $dttStartDate;

    const START_DATE_DEFAULT = null;
    const START_DATE_FIELD = 'start_date';


    /**
     * Protected member variable that maps to the database column device_tourist.end_date
     * @var \QCubed\QDateTime dttEndDate
     */
    private $dttEndDate;
     ...
     * in the database column device_tourist.device_id.
     *
    ...
    /**
     * Protected member variable that contains the object pointed by the reference
     * in the database column device_tourist.tourist_id.
     *
    ...
    /**
     * Construct a new DeviceTourist object.
    ...
    {
        $this->intDeviceId = DeviceTourist::DEVICE_ID_DEFAULT;
        $this->__blnValid[self::DEVICE_ID_FIELD] = true;
        $this->intTouristId = DeviceTourist::TOURIST_ID_DEFAULT;
        $this->__blnValid[self::TOURIST_ID_FIELD] = true;
        $this->dttStartDate = (DeviceTourist::START_DATE_DEFAULT === null)?null:new QDateTime(DeviceTourist::START_DATE_DEFAULT);
        $this->__blnValid[self::START_DATE_FIELD] = true;
        $this->dttEndDate = (DeviceTourist::END_DATE_DEFAULT === null)?null:new QDateTime(DeviceTourist::END_DATE_DEFAULT);
        $this->__blnValid[self::END_DATE_FIELD] = true;
    }
    ...
    **/
    ...
    /**
     * Load a DeviceTourist from PK Info
     * @param integer $intId
    ...
    public static function load($intId, $objOptionalClauses = null)
    {
        ...
        $objToReturn = DeviceTourist::querySingle(
            QQ::AndCondition(
                QQ::Equal(QQN::DeviceTourist()->Id, $intId)
            ),
            $objOptionalClauses
        );
        return $objToReturn;
    ...
    public static function loadAll($objOptionalClauses = null)
    {
        ...
        // Call DeviceTourist::queryArray to perform the LoadAll query
        try {
            return DeviceTourist::queryArray(QQ::All(), $objOptionalClauses);
        } catch (Caller $objExc) {
    ...
    /**
     * Count all DeviceTourists
     * @return int
     */
    public static function countAll()
    {
        // Call DeviceTourist::queryCount to perform the CountAll query
        return DeviceTourist::queryCount(QQ::All());
    }


    /**
     * Static Qcubed Query method to query for a single DeviceTourist object.
     ...
     * @return DeviceTourist the queried object
     */
    ...
    /**
     * Static Qcubed Query method to query for an array of DeviceTourist objects.
     * Offloads work to QModelTrait.trait.php
     * @param iCondition $objConditions any conditions on the query, itself
     * @param iClause[] $objOptionalClauses additional optional iClause objects for this query
     * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
     * @return DeviceTourist[] the queried objects as an array
     */
    ...
    public static function queryPrimaryKeys(iCondition $objConditions = null)
    {
        ...
        $clauses[] = QQ::Select(QQN::DeviceTourist()->Id);
        $objDeviceTourists = self::QueryArray($objConditions, $clauses);
        $pks = [];
        foreach ($objDeviceTourists as $objDeviceTourist) {
            $pks[] = $objDeviceTourist->intId;
        }
        return $pks;
    }
    ...
    */
    ...
    /**
     * Instantiate a DeviceTourist from a Database Row.
     * Takes in an optional strAliasPrefix, used in case another Object::instantiateDbRow
     * is calling this DeviceTourist::instantiateDbRow in order to perform
     ...
     * @return mixed Either a DeviceTourist, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
    */
    public static function instantiateDbRow(
        ...
        if (empty($objToReturn)) {
            // Create a new instance of the DeviceTourist object
            $objToReturn = new DeviceTourist(false);
            ...
            if (isset ($strColumnKeys[$strAliasName])) {
                ...
                $objToReturn->__blnValid[self::START_DATE_FIELD] = true;
            }
            else {
                $blnNoCache = true;
            }
            ...
            if (isset ($strColumnKeys[$strAliasName])) {
                ...
                $objToReturn->__blnValid[self::END_DATE_FIELD] = true;
            }
            else {
                $blnNoCache = true;
            }
        ...
        if (!$strAliasPrefix)
            $strAliasPrefix = 'device_tourist__';
        ...
        if (isset ($strColumns[$strAliasName])) {
            ...
            $objToReturn->objDevice = Device::instantiateDbRow($objDbRow, $strAliasPrefix . 'device_id__', $objExpansionNode, null, $strColumnAliasArray, false, 'devicetourist', $objToReturn);
        }
        ...
        if (isset ($strColumns[$strAliasName])) {
            ...
            $objToReturn->objTourist = Tourist::instantiateDbRow($objDbRow, $strAliasPrefix . 'tourist_id__', $objExpansionNode, null, $strColumnAliasArray, false, 'devicetourist', $objToReturn);
        }
    ...
    /**
     * Instantiate an array of DeviceTourists from a Database Result
    ...
    public static function instantiateDbResult(\QCubed\Database\ResultBase $objDbResult, Node\NodeBase $objExpandAsArrayNode = null, $strColumnAliasArray = null)
    {
        ...
        if ($objExpandAsArrayNode) {
            ...
            while ($objDbRow = $objDbResult->GetNextRow()) {
                $objItem = DeviceTourist::instantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
                if ($objItem) {
                    $objToReturn[] = $objItem;
            ...
            while ($objDbRow = $objDbResult->GetNextRow())
                $objToReturn[] = DeviceTourist::instantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
        }
    ...
    /**
     * Instantiate a single DeviceTourist object from a query cursor (e.g. a DB ResultSet).
     * Cursor is automatically moved to the "next row" of the result set.
     * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
     * @param \QCubed\Database\ResultBase $objDbResult cursor resource
     * @return DeviceTourist next row resulting from the query
     */
    public static function instantiateCursor(\QCubed\Database\ResultBase $objDbResult)
    {
        ...
        return DeviceTourist::instantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
    }
    ...
    /**
     * Load a single DeviceTourist object,
     * by Id Index(es)
     * @param integer $intId
     * @param iClause[] $objOptionalClauses additional optional iClause objects for this query
     * @return DeviceTourist
    */
    ...
    {
        return DeviceTourist::QuerySingle(
            QQ::AndCondition(
                QQ::Equal(QQN::DeviceTourist()->Id, $intId)
            ),
            $objOptionalClauses
    ...
    /**
     * Load an array of DeviceTourist objects,
    ...
    */
    ...
    {
        // Call DeviceTourist::QueryArray to perform the LoadArrayByDeviceId query
        try {
            return DeviceTourist::QueryArray(
                QQ::Equal(QQN::DeviceTourist()->DeviceId, $intDeviceId),
                $objOptionalClauses);
        } catch (Caller $objExc) {
            $objExc->incrementOffset();
            throw $objExc;
    ...
    */
    ...
    {
        // Call DeviceTourist::QueryCount to perform the CountByDeviceId query
        return DeviceTourist::QueryCount(
            QQ::Equal(QQN::DeviceTourist()->DeviceId, $intDeviceId)
        );
    }
    ...
    */
    ...
    {
        // Call DeviceTourist::QueryArray to perform the LoadArrayByTouristId query
        try {
            return DeviceTourist::QueryArray(
                QQ::Equal(QQN::DeviceTourist()->TouristId, $intTouristId),
                $objOptionalClauses);
        } catch (Caller $objExc) {
            $objExc->incrementOffset();
            throw $objExc;
    ...
    */
    ...
    {
        // Call DeviceTourist::QueryCount to perform the CountByTouristId query
        return DeviceTourist::QueryCount(
            QQ::Equal(QQN::DeviceTourist()->TouristId, $intTouristId)
        );
    }
    ...
    */
    ...
    /**
     * Insert into DeviceTourist
     */
    protected function insert()
    {
        $mixToReturn = null;
        $objDatabase = DeviceTourist::GetDatabase();

        $objDatabase->NonQuery('
            INSERT INTO `device_tourist` (
							`device_id`,
							`tourist_id`,
							`start_date`,
							`end_date`
        ...
        $mixToReturn = $this->intId = $objDatabase->InsertId('device_tourist', 'id');
	...
	*/
	protected function getValueClause()
    {
		...
		if (isset($this->__blnDirty[self::START_DATE_FIELD])) {
			$strCol = '`start_date`';
			$strValue = $objDatabase->sqlVariable($this->dttStartDate);
			$values[] = $strCol . ' = ' . $strValue;
		}
		if (isset($this->__blnDirty[self::END_DATE_FIELD])) {
			$strCol = '`end_date`';
			$strValue = $objDatabase->sqlVariable($this->dttEndDate);
			$values[] = $strCol . ' = ' . $strValue;
		}
		if ($values) {
			return implode(",\n", $values);
    ...
    public function delete()
    {
        if ((is_null($this->intId)))
            throw new \QCubed\Database\Exception\UndefinedPrimaryKey('Cannot delete this DeviceTourist with an unset primary key.');
    ...
    /**
	 * Reload this DeviceTourist from the database.
	...
	public function reload($clauses = null)
    {
		...
		if (!$this->__blnRestored)
			throw new Caller('Cannot call Reload() on a new, unsaved DeviceTourist object.');
		...
		// Reload the Object
		$objReloaded = DeviceTourist::Load($this->intId, $clauses);
		...
		if (isset($objReloaded->__blnValid[self::START_DATE_FIELD])) {
			$this->dttStartDate = $objReloaded->dttStartDate;
			$this->__blnValid[self::START_DATE_FIELD] = true;
		}
		if (isset($objReloaded->__blnValid[self::END_DATE_FIELD])) {
    ...
    /**
     *  Return an array of DeviceTourists keyed by the unique Id property.
     *	@param DeviceTourist[]
     *	@return DeviceTourist[]
     **/
    public static function keyDeviceTouristsById($devicetourists) {
        if (empty($devicetourists)) {
            return $devicetourists;
        }
        $ret = [];
        foreach ($devicetourists as $devicetourist) {
            $ret[$devicetourist->intId] = $devicetourist;
        }
        return $ret;
    }
    ...
    public function setDevice($objDevice) {
        if (is_null($objDevice)) {
            ...
            if (is_null($objDevice->Id)) {
                throw new Caller('Unable to set an unsaved Device for this DeviceTourist');
            }
    ...
    public function setTourist($objTourist) {
        if (is_null($objTourist)) {
            ...
            if (is_null($objTourist->Id)) {
                throw new Caller('Unable to set an unsaved Tourist for this DeviceTourist');
            }
	...
	*/
    ...
    {
		if ($this->__blnRestored && empty($this->__blnValid[self::START_DATE_FIELD])) {
			throw new Caller("StartDate was not selected in the most recent query and is not valid.");
		}
	...
	*/
	public function setStartDate($dttStartDate)
    {
		...
		if ($this->dttStartDate !== $dttStartDate) {
			$this->dttStartDate = $dttStartDate;
			$this->__blnDirty[self::START_DATE_FIELD] = true;
		}
		$this->__blnValid[self::START_DATE_FIELD] = true;
		return $this; // allows chaining
	}
   ...
   /**
	* Gets the value of dttEndDate 
	* @throws Caller
	* @return \QCubed\QDateTime
	*/
	public function getEndDate()
    {
		if ($this->__blnRestored && empty($this->__blnValid[self::END_DATE_FIELD])) {
			throw new Caller("EndDate was not selected in the most recent query and is not valid.");
		}
   ...
   /**
	* Sets the value of dttEndDate 
	* Returns $this to allow chaining of setters.
	* @param \QCubed\QDateTime|null $dttEndDate
    * @throws Caller
	* @return DeviceTourist
	*/
	public function setEndDate($dttEndDate)
    {
		$dttEndDate = Type::Cast($dttEndDate, QCubed\Type::DATE_TIME);

		if ($this->dttEndDate !== $dttEndDate) {
			$this->dttEndDate = $dttEndDate;
			$this->__blnDirty[self::END_DATE_FIELD] = true;
		}
		$this->__blnValid[self::END_DATE_FIELD] = true;
		return $this; // allows chaining
	}
	...
	*/
	protected static function broadcastInsert($pk)
    {
        if (static::$blnWatchChanges) {
            \QCubed\Project\Watcher\Watcher::markTableModified (static::getDatabase()->Database, 'device_tourist');
        }
	}
    ...
    */
    ...
    {
        $strToReturn = '<complexType name="DeviceTourist"><sequence>';
    ...
    {
        if (!array_key_exists('DeviceTourist', $strComplexTypeArray)) {
            $strComplexTypeArray['DeviceTourist'] = DeviceTourist::GetSoapComplexTypeXml();
    ...
    public static function getArrayFromSoapArray($objSoapArray)
    {
        ...
        foreach ($objSoapArray as $objSoapObject)
            array_push($objArrayToReturn, DeviceTourist::GetObjectFromSoapObject($objSoapObject));
    ...
    public static function getSoapArrayFromArray($objArray)
    {
        ...
        foreach ($objArray as $objObject)
            array_push($objArrayToReturn, DeviceTourist::GetSoapObjectFromObject($objObject, true));
    ...
    public function getIterator()
    {
        ...
        if (isset($this->__blnValid[self::START_DATE_FIELD])) {
            $iArray['StartDate'] = $this->dttStartDate;
        }
        if (isset($this->__blnValid[self::END_DATE_FIELD])) {
     ...
     * any query calls (like Load or QueryArray), with a call to DeviceTourist::ClearCache()
     *
    ...
    public function jsonSerialize ()
    {
        ...
        if (isset($this->__blnValid[self::START_DATE_FIELD])) {
            $a['start_date'] = $this->dttStartDate;
        }
        if (isset($this->__blnValid[self::END_DATE_FIELD])) {
            $a['end_date'] = $this->dttEndDate;
        }
        return $a;
    }
 ...
 * @property-read Node\Column $StartDate
 * @property-read Node\Column $EndDate
 * @property-read Node\Column $_PrimaryKeyNode
 **/
class NodeDeviceTourist extends Node\Table {
    protected $strTableName = 'device_tourist';
    protected $strPrimaryKey = 'id';
    protected $strClassName = 'DeviceTourist';
    ...
    */
    public function __get($strName) {
        switch ($strName) {
            ...
            case 'StartDate':
                return new Node\Column('start_date', 'StartDate', 'DateTime', $this);
            case 'EndDate':
                return new Node\Column('end_date', 'EndDate', 'DateTime', $this);
 ...
 * @property-read Node\Column $_PrimaryKeyNode
 **/
class ReverseReferenceNodeDeviceTourist extends Node\ReverseReference {
    protected $strTableName = 'device_tourist';
    protected $strPrimaryKey = 'id';
    protected $strClassName = 'DeviceTourist';
