...
class Vehicletypes extends \QCubed\Control\Panel {
	public $lblFilter;
	...
	public function __construct($objParentObject, $strControlId = null) {
		...
		$this->strTemplate			= __TEMPLATES__ .  '/pages/maintenance/vehicletypes.tpl.php';
	...
	private function Build() {		
		...
		$this->btnNew->AddAction(new \QCubed\Event\Click(), new \QCubed\Action\Redirect('/?c=maintenance&a=vehicletypeedit'));
		
		$this->lstVehicleTypes							= new \VehicleTypeList($this);
		$this->lstVehicleTypes->CssClass				= 'vehicle_table table';
		$this->lstVehicleTypes->AddJavascriptRowAction('maintenance','vehicletypeedit');
